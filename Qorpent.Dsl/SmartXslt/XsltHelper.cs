...
// 
// PROJECT ORIGIN: Qorpent.Dsl/XsltHelper.cs
#endregion
using System;
...
namespace Qorpent.Dsl.SmartXslt {
	...
	public class XsltHelper : ServiceBase, IXsltHelper {
		...
		public void Process(XElement source, TextWriter output, string transformFile) {
			...
			Process(source, xslttransform, args, extensions, new Uri(EnvironmentInfo.FULL_FILE_NAME_START + realTransformFileName), output);
		}
