...
// 
// PROJECT ORIGIN: Qorpent.Core/IAccessProvider.cs
#endregion
using System.Security.Principal;

namespace Qorpent.Security {
	/// <summary>
	/// 	Интерфейс определения прав доступа к объекту, должен быть при реализации расширяемым
	/// </summary>
	public interface IAccessProvider {
		...
		AccessResult IsAccessible(object target, AccessRole accessRole = AccessRole.Access, IPrincipal principal = null,
