...
namespace Qorpent.Utils.Tests.ScaleNormalizeTests {
    public partial class WorkingScalesOnGMKPres {
        ...
        [TestCase("3050,2600", 0, 3500, 6, true, 600, 0, true)]
        [TestCase("1679,1962,1427,1532", 0, 2000, 3, true, 300, 0, true)]
        [TestCase("1679,1962,1427,1532", 0, 2000, 7, true, 600, 0, true)]
        ...
        [TestCase("2709,2956,2041,592", 0, 3500, 6, true, 600,0,true)]
        ...
        [TestCase("16322.3,14065.2,10489.5,11295.5,7335.3,4008.1", 0, 18000, 2, true, 300,0, true)]
        [TestCase("1484,1558,1445,1434,1453", 0, 1600, 3, true, 600,0,true)]
        ...
        [TestCase("893,424,306,606,424,-537,-457,-261,-349,-214", -600, 1200, 5, true, 300, -1, true)]
        [TestCase("995,1073,795,774,501", 0, 1200, 3, true, 300, 0, true)]
        [TestCase("2323,2093,1556,1712,1110", 0, 2500, 4, true, 600, 0, true)]
        [TestCase("11694,3119,11394,3963", 0, 12000, 3, true, 300, 0, false)]
        [TestCase("2709,2956,2041,592", 0, 3000, 5, true, 300, 0, false)]
        [TestCase("2709,2956,2041,592", 0, 3500, 5, true, 600, 0, true)]
        [TestCase("523,450,383,313,197,69", 0, 600, 5, true, 300, 0, true)]
        [TestCase("98.5,96.5,10.8,101.1", 0, 120, 3, true, 300, 0, true)]
        [TestCase("3726,10610,8558,9264,1942", 0, 12000, 3, true, 300, 0, false)]
        [TestCase("3120.5,1865.6,1399.6,1883.6,1330.9,772.6,237.3", 0, 3500, 6, true, 600, 0, true)]
        [TestCase("16322.3,14065.2,10489.5,11295.5,7335.3,4008.1", 0, 18000, 2, true, 300, 0, true)]
