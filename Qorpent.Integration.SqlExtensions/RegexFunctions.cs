...
// 
// Solution: Qorpent
// Original file : RegexFunctions.cs
...
namespace Qorpent.Integration.SqlExtensions {
	...
	public static class RegexFunctions {
		...
		public static SqlRegexMatch RegexMatch(SqlString input, SqlString pattern) {
			return new SqlRegexMatch(input.Value, pattern.Value);
		}
	}
}