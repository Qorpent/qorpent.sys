namespace Qorpent.Scaffolding.Model{
	...
	public class GenerationOptions{
		...
		/// <returns></returns>
		public bool Supports(SqlObjectType fileGroup){
			if (IncludeSqlObjectTypes.HasFlag(fileGroup)) return true;
			if (ExcludeSqlObjectTypes.HasFlag(fileGroup)) return false;
