...
;                    }
            ...
            dialog.setupModule = function (module) {
                ...
                module.run(['$templateCache','$sce', function ($templateCache,$sce) {
                    ...
                    var prompt = '<div ng-bind-html="handler.message | unsafe"></div><input style="width:100%" on-enter="!handler.isValid || handler.success()" autoselect ng-model="handler.value"/>';
