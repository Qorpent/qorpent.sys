	...
	public static class BSharpErrors{
		...
		public static BSharpError ClassCreatedFormExtension(XElement source, string targetClassName){
			return new BSharpError{
				...
				Xml = source,
				Message =
					"Создание класса через расширение может быть сигналом того, что реальный класс не включен в сборку или переименован"
			};
		}
		...
		public static BSharpError ClassCreatedFormOverride(XElement source, string targetClassName){
			return new BSharpError{
				...
				Xml = source,
				Message =
					"Создание класса через перекрытие может быть сигналом того, что реальный класс не включен в сборку или переименован"
			};
		}
